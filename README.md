...
| `CORS_ALLOWED_ORIGINS` | No | Comma-separated Angular/browser origins; defaults to `http://localhost:4200,http://127.0.0.1:4200,https://emailautomationreporting.netlify.app,https://outreach.powersalesautomation.com` |
...
$env:CORS_ALLOWED_ORIGINS = "http://localhost:4200,http://127.0.0.1:4200,https://emailautomationreporting.netlify.app,https://outreach.powersalesautomation.com"
$env:PUBLIC_BASE_URL = ""
